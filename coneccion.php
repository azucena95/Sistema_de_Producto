<?php
$dsn = 'mysql:dbname=registro_producto;host=127.0.0.1';
$usuario = 'root';
$clave = '';
		...
		if (is_array($objeto)) {
			...
			foreach ($objeto as $datos) {
				...
				if ($editar != "0") {
					...
					@$tabla .= "<td><a href=".$form."Buscar.php?id=".$datos['id_producto'].">Modificar</a></dt>";
					@$tabla .= "<td><a href=".$form."Borrar.php?id=".$datos['id_producto'].">Eliminar</a></td>";
				}
				$tabla .= "</tr>";
			}
		 $tabla .= "</table>";	
